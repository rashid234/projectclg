...
router.get('/litricon',function(req,res) {
  ...
  router.get('/oozelagoon',function(req,res) {
    a=req.route.path;
    for(var [key,values] of Object.entries(events))
      {
